...
<html>
    ...
    <div class="container">
            ...
            <table class="table table-striped">
                ...
                <?php
                    $sql = mysqli_query($conn , "SELECT * FROM symptom_req JOIN patient_info WHERE symptom_req.phy_id='{$phy_id}' AND symptom_req.pat_id=patient_info.pat_id ORDER BY symptom_req.datesss DESC");
                    $i = 0;
